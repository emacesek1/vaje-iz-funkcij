...
% Risanje slik
\usepackage{tikz}
\usepackage{pgf} % dodan za risanje grafov s pomočjo GeoGebre
\usetikzlibrary{arrows} % dodan za risanje grafov s pomočjo GeoGebre
...
\newenvironment{resitev}{\par\noindent\emph{Rešitev.}}{\hfill $\Box$\par}
