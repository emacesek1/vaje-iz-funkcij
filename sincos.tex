...
\draw[line width=1.pt,color=qqwuqq,fill=qqwuqq,fill opacity=0.10000000149011612] (1.152776418235458,3.908501496011466) -- (1.3842749222239916,3.641277914246924) -- (1.6514985039885335,3.872776418235458) -- (1.42,4.14) -- cycle; 
\draw [shift={(-2.32,0.9)},line width=1.pt,color=qqwuqq,fill=qqwuqq,fill opacity=0.10000000149011612] (0,0) -- (0.01628264631072814:1.2) arc (0.01628264631072814:40.902716394791724:1.2) -- cycle;
\draw [line width=1.pt] (-2.32,0.9)-- (4.2252335288255765,0.9018600624050446);
\draw [line width=1.pt] (4.2252335288255765,0.9018600624050446)-- (1.42,4.14);
\draw [line width=1.pt] (1.42,4.14)-- (-2.32,0.9);
...
\draw[color=qqwuqq] (-0.66,1.47) node {$\alpha$};
\end{tikzpicture}
...
\draw [fill=uuuuuu] (-1.,0.) circle (1.5pt);
\draw[color=uuuuuu] (-1.1994933333333308,0.10001777777777895) node {$(-1, 0)$};
\draw [fill=uuuuuu] (0.,-1.) circle (1.5pt);
\draw[color=uuuuuu] (-0.20402666666666988,-1.1336888888888862) node {$(0, -1)$};
\draw [fill=uuuuuu] (0.,0.) circle (1.5pt);
\draw [fill=uuuuuu] (0.5527662281876642,0.8333363648462626) circle (1.5pt) node[right] {$P$};
\draw[color=uuuuuu] (0.98928,0.84257777777778);
...
\draw [line width=2.pt,color=ffxfqq] (0.,1.)-- (0.67,1.);
\draw [line width=2.pt,color=qqffqq] (1.,0.)-- (1.,1.5200985915492955);
